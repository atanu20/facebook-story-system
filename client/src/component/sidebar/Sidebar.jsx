...
const Sidebar = ({ppid}) => {
    ...
    const getMy=async()=>{
        ...
        const res=await axios.get('http://localhost:8000/allstory')
        ...
        <div className="sidebar">
            <div className="sidebarwrap">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Search By Name" value={search} onChange={(e)=>setSearch(e.target.value)} autoComplete="off" />
                </div>
                ...
                {/* {
                        ...
                        <img src={onestoryData[0].userproimg ? `http://localhost:8000/images/profile/${onestoryData[0].userproimg}` : `../image/pro.png`} alt="" className="userimg" />
                    ...
                    } */}
                     {
                        onestoryData?.map((val,ind)=>{
                            return(
                                <>
                 <div className="userboxwrap" key={ind} onClick={()=>handelviews(val._id,val.savepostid)}>
                        <img src={val.userproimg ? `http://localhost:8000/images/profile/${val.userproimg}` : `../image/pro.png`} alt="" className="userimg" />
